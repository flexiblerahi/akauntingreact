    ...
    axiosInstance
      ...
      .then((res) => {
        if (res.data.status === 'ok') {
          localStorage.setItem('authorizationValue', 'Basic ' + btoa(`${emailAddress}:${password}`));
          props.props.setUserEmail(emailAddress);
    ...
    <div className={classes.rootFull}>
      ...
      <div className={classes.containerSide}>
        ...
        <div className={classes.sideFormWrap}>
          <LoginForm emailAddress={emailAddress} setEmailAddress={setEmailAddress} password={password} setPassword={setPassword} handleSubmit={handleSubmit} />
        </div>
      </div>
    </div>
  );
