...
function UpdateAccount(props) {
  ...
  function handleClickCurrencyOpen() {
    setOpenCurrency(true);
  }

  function handleClickCurrencyClose() {
    setOpenCurrency(false);
  }
  const submitForm = (e) => {
    e.preventDefault();
    axiosInstance
      .post(`/accounts?company_id=${companyID}`, {
        name,
        number,
        ...
        >
          ...
          <form onSubmit={submitForm}>
            ...
            >
              ...
              <MenuItem>
                <Button variant="outlined" color="primary" onClick={handleClickCurrencyOpen}>
                  Add Currencies
                </Button>
              </MenuItem>
            </TextField>
