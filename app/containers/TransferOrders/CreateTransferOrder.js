...
function CreateTransferOrder(props) {
                    ...
                    <form onSubmit={submitForm}>
                        ...
                        <div>
                            ...
                            {inputFields.map((input, index) => (
                                <div key={index}>
                                    <FormControl className={classes.formControl}>
                                        <InputLabel htmlFor="name-simple">Item</InputLabel>
                                        <Input onChange={(e) => handleItemNameChange(e, index)} />
                                    </FormControl>
                                    <FormControl className={classes.formControl}>
                                        <InputLabel htmlFor="name-simple">Item Quantity</InputLabel>
                                        <Input onChange={(e) => handleItemValueChange(e, index)} />
                                    </FormControl>
                                    <FormControl className={classes.formControl}>
                                        <InputLabel htmlFor="name-simple">Transfer Quantity</InputLabel>
                                        <Input onChange={(e) => handleItemValueChange(e, index)} />
                                    </FormControl>
...
CreateTransferOrder.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(CreateTransferOrder);
